...
* 析构函数：主要作用在于**对象销毁前**系统自动调用，执行一些**清理工作**。
...
<img src="F:\C++学习资料\Markdown笔记\assets\析构调用.png" alt="500" style="zoom:60%;" />
...
![](F:\C++学习资料\Markdown笔记\assets\4.2.7.png)**运行结果**：先调用构造的，最后进行析构，类似于栈的FILO
